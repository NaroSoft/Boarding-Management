...
class Head_Login_Home extends StatefulWidget {
  final String text,text2;
  const Head_Login_Home({Key? key,required this.text, required this.text2}) : super(key: key);
  @override
  _Head_Login_HomeState createState() => _Head_Login_HomeState();
}

class _Head_Login_HomeState extends State<Head_Login_Home>{
  int ttnumb=0;
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Route route= MaterialPageRoute(builder: (context)=>Head_Login_Home(text: widget.text2,text2: widget.text));
